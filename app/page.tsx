...
const resources: Resource[] = [
  ...
  { title: 'Slow Chinese', chinese: '慢速中文', category: 'Listen', level: [1, 2, 3], description: 'Short cultural stories spoken clearly, with transcripts for close listening.', price: 'Free', href: 'https://slow-chinese.com/' },
  ...
  { title: 'The Bad Kids', chinese: '隐秘的角落', category: 'Watch', level: [3, 4], description: 'A compact suspense drama with contemporary speech and an unforgettable story.', price: 'Freemium', href: 'https://www.iq.com/album/the-bad-kids-2020-1t1ci4p1kh5' },
  ...
  { title: 'Hikaru no Go', chinese: '棋魂', category: 'Watch', level: [3, 4], description: 'A warm coming-of-age drama; recurring settings make its vocabulary easier to acquire.', price: 'Freemium', href: 'https://www.iq.com/album/hikaru-no-go-2020-17w3hq8o5ud' },
