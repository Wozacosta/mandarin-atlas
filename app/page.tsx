...
const resources: Resource[] = [
  ...
  { title: 'When History Meows', chinese: '如果历史是一群喵', category: 'Culture', level: [1, 2, 3], description: 'A playful, fully captioned animation that retells Chinese history in approachable modern Mandarin.', price: 'Freemium', href: 'https://www.bilibili.com/bangumi/play/ss25469/' },
  { title: 'Xiaolin Says', chinese: '小Lin说', category: 'Culture', level: [3, 4, 5], description: 'Fast, visual explainers on economics, technology, business, and society with clear on-screen captions.', price: 'Free', href: 'https://www.youtube.com/c/Lindsay%E8%AF%B4' },
  { title: 'Teacher Li Yongle', chinese: '李永乐老师', category: 'Culture', level: [4, 5], description: 'Whiteboard lessons that unpack history, economics, mathematics, and science in precise native Mandarin.', price: 'Free', href: 'https://www.youtube.com/channel/UCSs4A6HYKmHA2MG_0z-F0xw' },
  { title: 'Under the Microscope', chinese: '显微镜下的大明', category: 'Culture', level: [4, 5], description: 'A tightly focused Ming drama about taxes, local government, and ordinary lives—history through one real dispute.', price: 'Free', href: 'https://www.youtube.com/watch?v=xLIfqMm43Bo' },
  ...
  { title: 'Chinese Sentences', chinese: '句子', category: 'Grammar', level: [0, 1, 2, 3, 4, 5], description: 'Make grammar stick through sentence mining, spaced repetition, customizable decks, and simplified or traditional text.', price: 'Free', href: 'https://chinesesentences.com/' },
  ...
  { title: 'Anki', category: 'Apps', level: [0, 1, 2, 3, 4, 5], description: 'Powerful spaced-repetition flashcards for keeping the words and sentences you actually meet.', price: 'Freemium', href: 'https://apps.ankiweb.net/' },
  { title: 'Zhongwen Popup Dictionary', chinese: '中文词典', category: 'Apps', level: [1, 2, 3, 4, 5], description: 'Hover over Chinese on any webpage for instant definitions, pinyin, and simplified–traditional forms.', price: 'Free', href: 'https://chromewebstore.google.com/detail/zhongwen-chinese-english/kkmlkkjojmombglmlpbpapmhcaljjkde' },
  { title: 'Lingotrack', category: 'Apps', level: [0, 1, 2, 3, 4, 5], description: 'Track immersion, discover level-rated Chinese media, and turn your reading and listening into visible progress.', price: 'Freemium', href: 'https://lingotrack.com/' },
  ...
  { title: 'WeRead', chinese: '微信读书', category: 'Books', level: [3, 4, 5], description: 'Tencent’s polished native ebook and audiobook library—an ideal home base once graded readers feel small.', price: 'Freemium', href: 'https://weread.qq.com/' },
  { title: 'Bilibili', chinese: '哔哩哔哩', category: 'Watch', level: [2, 3, 4, 5], description: 'China’s vast video ecosystem for donghua, documentaries, explainers, creators, and captioned native media.', price: 'Freemium', href: 'https://www.bilibili.com/' },
  ...
  { title: 'Learning Chinese Through Stories', chinese: '听故事说中文', category: 'Listen', level: [1, 2, 3, 4, 5], description: 'Immersive stories and walkthroughs delivered entirely in Chinese, from beginning to superior levels.', price: 'Freemium', href: 'https://www.learningchinesethroughstories.com/' },
  { title: 'Learn Taiwanese Mandarin', category: 'Listen', level: [2, 3, 4, 5], description: 'Natural intermediate-to-advanced Mandarin, Taiwan culture, and difficult words explained in easier Chinese.', price: 'Freemium', href: 'https://podcasts.apple.com/us/podcast/learn-taiwanese-mandarin/id1502494666' },
  ...
  { title: 'Peppa Pig', chinese: '小猪佩奇', category: 'Watch', level: [1, 2], description: 'Gentle passive listening with strong visual context; official uploads do not consistently include matching Chinese subtitles.', price: 'Free', href: 'https://www.youtube.com/@PeppaPigChineseOfficial' },
  ...
  { title: 'The Bald King', chinese: '秃秃大王', category: 'Books', level: [2, 3], description: 'Heavenly Path’s favorite first native novel: a short, funny children’s satire with manageable prose.', price: 'Paid', href: 'https://www.overdrive.com/media/4359492/%E7%A7%83%E7%A7%83%E5%A4%A7%E7%8E%8B' },
  { title: 'Dalin and Xiaolin', chinese: '大林和小林', category: 'Books', level: [2, 3], description: 'An imaginative native children’s classic paired here with a human-narrated audiobook for supported reading.', price: 'Freemium', href: 'https://www.himalaya.com/courses/1702241' },
